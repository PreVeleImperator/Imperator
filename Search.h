...
constexpr int NO_MOVE   = -13'000;
constexpr int CHECKMATE = -12'000;
...
uint64_t timeStart;
uint64_t actualPath [MAX_PLY];
uint64_t actualHashCode;
...
int Quiescence (bool player, bool opponent, uint64_t enpassant,                 int ply,            int alpha, int beta               );
